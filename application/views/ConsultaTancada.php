  ...
  <div class='row mt-5'>
    ...
    <div class="alert alert-success">
      ...
      <div class="alert-message text-center">
        <p><strong>S'ha tancat la consulta correctament!</strong></p>
        
      
      </div>
      <div class=" d-flex  justify-content-center">
      <a  href="http://localhost/Small/index.php/SmallController/Atencio"  id="bcolor10" class="btn">Tornar</a>
      </div>
    </div>
  </div>
  </div>
