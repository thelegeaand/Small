...
<span ><img id="imgModal" src="<?php echo base_url(); ?>img/Test-image-11.png"></span>
  ...
  <div class="container float-left ml-5 mt-3 mb-3 text-center  p-4 d-none d-sm-none d-md-block d-xl-block" style=" background-color:whitesmoke;width:250px;height:340px; border:1px solid #07FB7F;border-radius:7px;">
      ...
      <a href="#" id="bcolor1" class="ml-1 mt-2 text-center" >Fuiteries </a>
   ...
   <section id="Botigues mb-4 mt-5" >


<div class="container d-flex justify-content-right mt-5 mb-5  " >
