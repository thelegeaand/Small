  ...
  <div class='row mt-5'>
    ...
    <div class="alert alert-success">
      ...
      <div class="alert-message text-center">
        <p><strong>S'ha tramitat la comanda correctament.<br>T'hem enviat un correu!</strong></p>
        
      
      </div>
      <div class=" d-flex  justify-content-center">
      <a  href="http://localhost/Small/index.php/SmallController/TancarSessio"  id="bc10" class="btn ml-2">Sortir</a>
      </div>
    </div>
  </div>
  </div>
