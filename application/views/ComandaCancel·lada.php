...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@1,200&family=Poppins:wght@800&display=swap" rel="stylesheet">
  ...
  <title>Comanda Cancel·lada</title>
</head>
<body>
  ...
  <div class='row mt-5'>
    ...
    <div class="alert alert-success">
      ...
      <div class="alert-message text-center">
        <p><strong>La Comanda ha sigut cancel·lada!</strong></p>
    
      </div>
      <div class=" d-flex  justify-content-center">
      <a  href="http://localhost/Small/index.php/SmallController/HistorialComandes"  id="bcolor10" class="btn">Tornar</a>
      </div>
    </div>
  </div>
  </div>
